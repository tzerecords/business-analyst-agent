...
<p align="center"><img src="assets/example/purchase-request.svg" width="640" alt="Purchase request, generated from bpmn/examples/purchase-request.spec.json"></p>

Generated by the skill from bpmn/examples/purchase-request.spec.json, then passed through the checker.
```bash
